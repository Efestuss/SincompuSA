...
public class frmAdmin extends javax.swing.JFrame {
    ...
    private ctrlProductos productos;
    ...
    private void initComponents() {
        ...
        bgPanel.setPreferredSize(new java.awt.Dimension(1090, 600));
        bgPanel.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        sideBarPanel.setBackground(new java.awt.Color(209, 230, 236));
        sideBarPanel.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        btnProductos.setBackground(new java.awt.Color(128, 128, 197));
        ...
        sideBarPanel.add(btnReportes, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 366, -1, -1));
        ...
        jTableProductos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id_Producto", "Nombre", "Cantidad", "Precio", "Categoria", "Proveedor"
            }
        ));
    ...
    private void btnNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNuevoActionPerformed
        frmNuevoProducto nuevoProducto = new frmNuevoProducto(this); // Donde "this" se refiere a la instancia de frmProveedor actual

        // Generar el nuevo ID utilizando el método de la clase ctrlProveedor
        String nuevoID;
        try {
            nuevoID = ctrlProductos.generarNuevoIDProducto();
            nuevoProducto.setLblIDText(nuevoID);
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        if (opcion == JOptionPane.YES_OPTION) {
            ...
            Object idProductoObj = jTableProductos.getValueAt(filaSeleccionada, 0);
            // Verifica si el ID del proveedor es nulo
            if (idProductoObj == null) {
                JOptionPane.showMessageDialog(this, "El ID del producto seleccionado es nulo.", "Error", JOptionPane.ERROR_MESSAGE);
                System.out.println("El id es nulo");
                return;
            }
            String idProducto = idProductoObj.toString();
            System.out.println("El id no es nulo: " + idProducto);
    ...
    public void actualizarTabla() {
        ...
        productos.cargarDatosTablaProductos(modeloTabla);
    ...
    public void cargarDatos() throws ClassNotFoundException, SQLException {
        ...
        ctrlProductos controlador = new ctrlProductos();

        List<Producto> productos = controlador.obtenerProductos();

        for (Producto producto : productos) {
            modelo.addRow(new Object[]{producto.getIdProducto(), producto.getNombre(), producto.getCantidad(), producto.getPrecio(), producto.getCategoria(), producto.getProveedor()});
        }
    }
